...
class XLMRobertaBase(torch.nn.Module):
    def __init__(self):
        ...
        self.l1 = transformers.XLMRobertaModel.from_pretrained('xlm-roberta-base', return_dict=False, output_attentions=True)
        self.l2 = torch.nn.Dropout(0.3)
        self.l3 = torch.nn.Linear(768, COUNT_TECHNIQUES)

    def forward(self, ids, mask, token_type_ids):
        _, output_1, attentions = self.l1(ids, attention_mask=mask, token_type_ids=token_type_ids, output_attentions=True)
